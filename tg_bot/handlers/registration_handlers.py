...
def confirm_register(update: Update, context: CallbackContext) -> int:
...
def save_register_data(update: Update, context: CallbackContext) -> int:
    ...
    return confirm_register(update=update, context=context)


def adding_password(update: Update, context: CallbackContext) -> int:
    context.user_data[PASSWORD] = update.message.text
    return save_register_data(update=update, context=context)


def password_request(update: Update) -> int:
...
def adding_email(update: Update, context: CallbackContext) -> int:
    ...
    try:
        ...
        return email_request(update=update)
    ...
    return password_request(update=update)


def email_request(update: Update) -> int:
    update.message.reply_text(
...
def adding_username(update: Update, context: CallbackContext) -> int:
    ...
    try:
        ...
        return username_request(update=update)
...
def username_request(update: Update) -> int:
    update.message.reply_text(
...
def start_register(update: Update, context: CallbackContext) -> int:
...
def register(update: Update, context: CallbackContext) -> int:
    ...
    return start_register(update=update, context=context)
